...
| ----------------------------- | ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------- | -------------------------------------------------------------------------------- |
| gemini-2.5-pro                | gemini网页版<br>                      | [[Gemini DeepResearch]]<br>退订了之前的[[ChatGPT 桌面端]]。                                                                       | 10%            | DeepResearch：Gemini / ChatGPT / Grok / Perplexity 效果对比（空占位已合并）                          |
...
| sonar-pro                     | 15%                                                                                                                     | \[\[Perplexity |                                                                                  |
| gpt-o3                        | [[Raycast AI Chat]]                | 1. 偏STEM的问题，有复杂度的问题。<br>2. 做为其他模型解决失败的fallback备用。                                                                       | 10%            | raycast 使用send x to ai chat功能，让ai成为ocr翻译一样，原生习惯的存在，像呼吸一样自然。 |
...
| 客户端                  | 模型选择                                                             | 使用时间占比 | 快捷键            |
| -------------------- | ---------------------------------------------------------------- | ------ | -------------- |
| Raycast | sonar-pro, gpt-o3, gpt-4.1                                       | 30%    | option + space |
| [[Cursor]]           | gemini-2.5-pro, claude-4-sonnet                                  | 25%    | hyper + c      |
| Gemini   | gemini-2.5-pro                                                   | 20%    | hyper + g      |
