...
created: 2025-07-15
modified: 2026-04-26
published: 2026-05-16T01:30:27.459+08:00
---
...
这页是数字花园概念的 canonical note；更完整的边界判断、发布风险和 PKM 分工已经进入 [[Atlas/LLM Wiki/_index|LLM Wiki]] 编译层。后续如果继续整理，不要只补工具链接，优先判断它是在讨论公开性、维护成本、第二大脑分层，还是发布前阻断。

- [[Atlas/LLM Wiki/Concepts/数字花园|数字花园 concept]]
- [[Atlas/LLM Wiki/Synthesis/数字花园、第二大脑与 PKM 方法论 阅读地图|数字花园、第二大脑与 PKM 方法论 阅读地图]]
- [[Atlas/LLM Wiki/Synthesis/数字花园发布前阻断清单与公开呈现清单如何分工|数字花园发布前阻断清单与公开呈现清单如何分工]]
