...
created: 2022-08-05
modified: 2023-03-14
published: 2026-05-16T01:30:28.697+08:00
---
...
，决定批量改用`∑`符号，option+w输入。因为+过于常用，搜索的时候会有过多干扰项，另外可能会被某些系统识别为保留字符而出错，比如在hugo中会出现404问题。
option +w被用于[[Raycast]]指定打开[[Warp App]]的快捷键，固弃用`∑`符号，并且TOC不常用，改用 `§`符号作为前缀。
