...
var ThemeSwitcher = ((options) => {
  ...
  const Component = ({ displayClass, cfg }) => {
    ...
    const translations2 = i18n(cfg?.locale);
    return /* @__PURE__ */ u2("div", { class: classes, "data-theme-switcher-shell": true, children: [
      ...
      /* @__PURE__ */ u2("label", { class: "theme-switcher-label", for: "theme-switcher-select", children: translations2.label }),
      /* @__PURE__ */ u2(
        "select",
        {
          ...
          "aria-label": translations2.presetLabel,
          name: "theme-preset",
      ...
      /* @__PURE__ */ u2(
        "button",
        {
          ...
          "data-theme-shuffle": true,
          "aria-label": translations2.shuffleLabel,
          title: translations2.shuffleLabel,
          disabled: true
        }
      )
    ] });
...
export { ThemeSwitcher_default as ThemeSwitcher };
